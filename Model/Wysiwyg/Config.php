 ...
 */
namespace Lof\ProductTags\Model\Wysiwyg;
...
class Config extends \Magento\Framework\DataObject implements ConfigInterface
{
     ...
     * @deprecated 103.0.0
     * @see \Lof\ProductTags\Model\ConfigProvider::processVariableConfig
     */
     ...
     * @deprecated 103.0.0
     * @see \Lof\ProductTags\Model\ConfigProvider::processWidgetConfig
     */
    ...
    /**
     * @var \Lof\ProductTags\Model\Wysiwyg\CompositeConfigProvider
     */
    ...
    public function __construct(
        ...
        array $windowSize = [],
        array $data = [],
        \Lof\ProductTags\Model\Wysiwyg\CompositeConfigProvider $configProvider = null
    ) {
        ...
        $this->configProvider = $configProvider ?: ObjectManager::getInstance()
            ->get(\Lof\ProductTags\Model\Wysiwyg\CompositeConfigProvider ::class);
